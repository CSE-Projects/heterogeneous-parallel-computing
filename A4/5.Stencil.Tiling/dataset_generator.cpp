...
static void compute(unsigned char *out, unsigned char *in, int width, int height, int depth) {
...
static unsigned char *generate_data(int width, int height, int depth) {
	...
	unsigned char *data = (unsigned char *)
		malloc(sizeof(unsigned char) * width * height * depth);
...
static void write_data(const char *file_name, unsigned char *data, int width, 
